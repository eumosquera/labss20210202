<%-- 
    ...
    Created on : 4/02/2021, 04:21:50 PM
    Author     : ing.soporte
--%>
                ...
                <form method="post" action="Operacion">
                    ...
                    <div class="form-row">
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="number" placeholder="Ingresa el numero" id="txtnumero" name="txtn1" />
                        </div>
                    </div>
                    <hr>
                    <div class="form-row">
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="number" placeholder="Ingresa el numero" id="txtnumero" name="txtn2" />
                        </div>
                    </div>
                    <hr>
                    <div class="form-row">
